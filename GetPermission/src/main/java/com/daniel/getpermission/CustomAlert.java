...
public class CustomAlert {
    ...
    private AlertDialog showAlertDialog(Context context,
                                        ...
                                        @Nullable DialogInterface.OnClickListener dialogNegativeClickListener,
    ...
    AlertDialog showAlertDialog(Context ctx,
                                String dialogTitle,
                                int titleIcon,
                                String dialogMessage,
                                String positiveButtonText,
                                DialogInterface.OnClickListener dialogPositiveClickListener,
                                String negativeButtonText, boolean isCancellable) {
